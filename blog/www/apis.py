...
class Page(object):
    def __init__(self,item_count,page_index=1,page_size=10):
        self.item_count = item_count #数据库博客总数
        self.page_size = page_size #每一页容纳博客的数目
        ...
        self.has_next = self.page_index < self.page_count #是否有后一页
        self.has_previous = self.page_index > 1 #是否有前一页
